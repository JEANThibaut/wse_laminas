    ...
    repliqueTable = new DataTable('#repliqueTable', {
        ...
        columns: [
             ...
             },
            {
                ...
                sortable:false,
                render: (data) => {
                    return `<span class="delete-replique-btn text-danger" data-id="${data}" style="cursor:pointer;"><i class="fas fa-trash"></i></span>`;
                }
            }
        ],
        columnDefs: [
...
function handleDeleteReplique(event) {
    ...
    .catch(err => {
        console.error('Erreur AJAX suppression :', err);
    });
}
